				...
				<?php if (get_post_meta($post->ID, 'ale_phone', true)): ?>
					<div class="c-contact">
						...
						<p>Phone:
							<span>
								<strong>
									<?php echo esc_attr(get_post_meta($post->ID, 'ale_phone', true))?>
								</strong>
							</span>
						</p>
					</div>
				<?php endif; ?>
					...
					<div class="c-contact">
						...
						<p>Adress:
							<span>
								<strong>
									<?php echo esc_attr(get_post_meta($post->ID, 'ale_address', true))?>
								</strong>
							</span>
						</p>
					</div>
				...
				<?php if (get_post_meta($post->ID, 'ale_email', true)): ?>
					<div class="c-contact">
						...
						<p>E-mail:
							<span>
								<strong>
									<?php echo esc_attr(get_post_meta($post->ID, 'ale_email', true))?>
								</strong>
							</span>
						</p>
					</div>
